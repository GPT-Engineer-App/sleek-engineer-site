import { Box, Button, Container, Flex, Heading, IconButton, Image, Link, Stack, Text, useColorMode, useColorModeValue, VStack, Link as ChakraLink } from "@chakra-ui/react";
    ...
    <Container maxW="container.xl" p={0} display="flex">
      <Flex direction="row" w="full">
        <VStack position="absolute" left={0} top={0} h="100vh" w={{ base: "100%", md: "200px" }} bg="rgba(255, 255, 255, 0.9)" p={4} spacing={4} zIndex="overlay">
          ...
          <ChakraLink href="#projects" p={2}>
            Projects
          </ChakraLink>
          <ChakraLink href="#skills" p={2}>
            Skills
          </ChakraLink>
          <ChakraLink href="#blog" p={2}>
            Blog
          </ChakraLink>
          <ChakraLink href="#contact" p={2}>
            Contact
          </ChakraLink>
        </VStack>
        <Flex direction="column" align="center" minHeight="100vh" bg={bgColor} color={textColor} pl="200px">
